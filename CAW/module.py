...
class CAWN(torch.nn.Module):
    ...
    def contrast_modified(self, src_idx_l, tgt_idx_l, cut_time_l, e_idx_l, pos_edge, test=False):
        ...
        self.flag_for_cur_edge = pos_edge
        link_score = self.forward(src_idx_l, tgt_idx_l, cut_time_l, (subgraph_src, subgraph_tgt), test=test)
        return link_score.sigmoid() 
