...
from evaluation.evaluation_LP import eval_link_pred, eval_link_pred_one_snapshot
...
for i_run in range(args.start_run_idx, args.n_runs):
    ...
    train_val_LP(tgn, train_val_data, train_val_sampler, NUM_NEIGHBORS, partial_ngh_finder, full_ngh_finder, 
