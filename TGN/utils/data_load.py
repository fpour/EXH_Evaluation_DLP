...
def get_data(dataset_name, args, logger=None, verbose=True, test_nn_ratio=0.1):
    # First, set the seed!
    ...
    new_test_node_set = set(random.sample(test_node_set, int(test_nn_ratio * n_total_unique_nodes)))  
